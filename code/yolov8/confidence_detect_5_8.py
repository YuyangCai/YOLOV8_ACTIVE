...
SAMPLES_DIR = Path('/home/cyy/code/samples/test16')
...
for cycle in range(cycles):
    ...
    if cycle == 0:
        ...
        model.train(data=os.path.join(BASE_PATH, TEMP_YAML), model=str(latest_weights_path), epochs=150, imgsz=224, batch=16, lr0=0.01, cache=True, resume=True)
